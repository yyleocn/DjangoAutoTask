# Generated by Django 4.1.5 on 2023-01-18 14:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.SmallIntegerField(choices=[(10, 'Max'), (20, 'Scheme'), (50, 'Normal'), (100, 'Idle')], default=50)),
                ('pause', models.BooleanField(default=False)),
                ('cancel', models.BooleanField(default=False)),
                ('funcPath', models.TextField()),
                ('argsStr', models.TextField(blank=True, default=None, null=True)),
                ('kwargsStr', models.TextField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(max_length=50, null=True)),
                ('planTime', models.BigIntegerField(default=0)),
                ('execTimeLimit', models.SmallIntegerField(default=AutoTask.models.defaultExecTimeLimit)),
                ('retryDelay', models.SmallIntegerField(default=AutoTask.models.defaultRetryDelay)),
                ('execLimit', models.SmallIntegerField(default=AutoTask.models.defaultExecLimit)),
                ('priority', models.SmallIntegerField(choices=[(10, 'Max'), (20, 'Scheme'), (50, 'Normal'), (100, 'Idle')], default=50)),
                ('pause', models.BooleanField(default=False)),
                ('cancel', models.BooleanField(default=False)),
                ('funcPath', models.TextField()),
                ('argsStr', models.TextField(blank=True, default=None, null=True)),
                ('kwargsStr', models.TextField(blank=True, default=None, null=True)),
                ('blockKey', models.CharField(default=None, max_length=20, null=True)),
                ...
                ('errorCode', models.IntegerField(choices=[(1001, 'Crash'), (2001, 'Timeout'), (3001, 'Invalidconfig')], null=True)),
